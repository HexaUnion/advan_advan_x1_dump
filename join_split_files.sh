...
cat system/system/media/config/wallpaper/anim04/anim04.mp4.* 2>/dev/null >> system/system/media/config/wallpaper/anim04/anim04.mp4
rm -f system/system/media/config/wallpaper/anim04/anim04.mp4.* 2>/dev/null
cat system/system/app/PriChargingAni/PriChargingAni.apk.* 2>/dev/null >> system/system/app/PriChargingAni/PriChargingAni.apk
rm -f system/system/app/PriChargingAni/PriChargingAni.apk.* 2>/dev/null
